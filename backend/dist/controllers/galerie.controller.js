...
exports.getGalerieData = exports.deletePhoto = exports.modererPhoto = exports.uploadPhoto = exports.getGaleriePage = void 0;
...
const getGaleriePage = async (req, res) => {
    try {
        const { slug } = req.params;
        const wedding = await prisma_1.prisma.wedding.findUnique({ where: { slug } });
        const htmlPath = path_1.default.join(process.cwd(), 'public', 'galerie.html');
        ...
        const photos = await prisma_1.prisma.photoGalerie.findMany({
...
exports.getGaleriePage = getGaleriePage;
...
const uploadPhoto = async (req, res) => {
    try {
        ...
        const photo = await prisma_1.prisma.photoGalerie.create({
            data: {
...
exports.modererPhoto = modererPhoto;
const deletePhoto = async (req, res) => {
    try {
        ...
        await prisma_1.prisma.photoGalerie.delete({ where: { id: photoId } });
...
exports.getGalerieData = exports.getGaleriePage;
