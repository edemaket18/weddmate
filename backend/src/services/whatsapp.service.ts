...
interface SendMessageParams {
  to: string        // format international : +22890000000
  message: string
}

export const sendWhatsAppMessage = async ({ to, message }: SendMessageParams) => {
...
export const buildMessage = (type: string, data: {
  nomCeremonie: string
  dateJourJ: Date
